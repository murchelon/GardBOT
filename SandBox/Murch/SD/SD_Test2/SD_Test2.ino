...
void setup() {
  ...
  // Initialize the SD.
  if (!SD.begin(CS_PIN, SPI_SIXTEENTH_SPEED)) {
  ...
  FullPathFile_Plants = F("Gardbot/Plants/Plants.txt");


  // Create the file.
  file = SD.open(FullPathFile_Plants, FILE_READ);
  if (!file) {
  ...
  file.print(F(
#if CSV_DELIM == ','
    "36,22222,20.70,57.60,79.50,01:08:14,23.06.16\r\n"
    "37,23.21,20.71,57.61,79.51,02:08:14,23.07.16\r\n"
#elif CSV_DELIM == ';'
    "36;3333333.20;20.70;57.60;79.50;01:08:14;23.06.16\r\n"
    "37;23.21;20.71;57.61;79.51;02:08:14;23.07.16\r\n"
#else
#error "Bad CSV_DELIM"
#endif
...
String Porra = F("");
    ...
    while (file.available())
    {
        ...
        */
        ...
        Porra += String(dateS) + String(F(";"));

        //Serial.println(dateS);

        /*
        if (csvReadText(&file, dateS, sizeof(dateS), CSV_DELIM) != '\n') 
        {
